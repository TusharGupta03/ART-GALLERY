...
<body>
    <header class="nav">
        ...
        <div class="navbuttons">
            ...
            <div class="buttonnavdiv">
                <a href="logout.php"><button class="buttonnav">Past Orders</button></a>
            </div>

            <div class="buttonnavdiv">
                <a href="orders.php"><button class="buttonnav">Log out</button></a>
            </div>
    ...
    $query = "select * from orders,sold_out  where username='$name1' and orders.titl=sold_out.TITLE  ";
                ...
                <div class="items">
                    <div class="body">
                        ...
                        <div class="content">
                            ...
                            <div class="btns">
                                <div class="buy">
                                     <button class="buybtn">Delivered</button>
                                </div>
    ...
    <?php } else { ?>
        <p class="status_error">Oops....NOTHING IN orders</p>
    <?php } ?>
</body>
